...
このリポジトリは、2025年2月22日に開催された「光の塔 感謝の日」の一環として実施されたプロジェクションマッピングのUnityプロジェクトを、就職活動・ポートフォリオ用に軽量化したものです。
...
- [制作経緯・プロジェクト紹介](https://www.wantedly.com/users/203819397/post_articles/1065227)
...
- Arduino連携・ランタン挙動制御: mdouke
- スカイランタン3Dモデル: チームメンバー
- 元プロジェクト: チーム制作

## License / Rights

このリポジトリはポートフォリオ閲覧用です。

コードの一部は作者本人が実装したものですが、3Dモデルなどチーム制作物を含むため、リポジトリ内の素材・データの無断利用、再配布、改変はご遠慮ください。
